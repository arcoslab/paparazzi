...
IMU_STM32F3_CFLAGS  = -DUSE_IMU
IMU_STM32F3_CFLAGS += -DIMU_TYPE_H=\"imu/imu_stm32f3.h\"
IMU_STM32F3_SRCS    = $(SRC_SUBSYSTEMS)/imu.c             \
                      $(SRC_SUBSYSTEMS)/imu/imu_stm32f3.c

ifndef STM32F3_BUS
STM32F3_BUS = I2C2
endif

IMU_STM32F3_CFLAGS += -DUSE_$(STM32F3_BUS) -D$(STM32F3_BUS)_CLOCK_SPEED=100000

ifeq ($(ARCH), lpc21)
#TODO
$(error Not implemented for the LCP21x yet. Needs the new SPI mcu_periph. See issue 147!)
else ifeq ($(ARCH), stm32)
IMU_STM32F3_CFLAGS +=  -DUSE_EXTI9_5_IRQ    # MPU and Mag Int
endif

IMU_STM32F3_CFLAGS += -DIMU_STM32F3

# Keep CFLAGS/Srcs for imu in separate expression so we can assign it to other targets
# see: conf/autopilot/subsystems/lisa_passthrough/imu_b2_v1.1.makefile for example

ap.CFLAGS += $(IMU_STM32F3_CFLAGS)
ap.srcs   += $(IMU_STM32F3_SRCS)
