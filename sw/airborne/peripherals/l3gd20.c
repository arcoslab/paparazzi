...
/**
 * @file peripherals/l3gd20.c
 *
 * Driver for L3GD20 from ST.
 */

#include "peripherals/l3gd20.h"
#include "std.h"

void l3gd20_set_default_config(struct L3gd20Config *c) {
  c->ctrl_reg1 = L3GD20_DEFAULT_CTRL_REG1;
  c->ctrl_reg5 = L3GD20_DEFAULT_CTRL_REG5;
}

/**
 * Initialize L3gd20 struct and set default config options.
 * @param l3g   L3gd20 struct
 * @param i2c_p I2C periperal to use
 * @param addr  I2C address of L3GD20
 */

void l3gd20_init(struct L3gd20 *l3g, struct i2c_periph *i2c_p, uint8_t addr)
{
  /* set i2c_peripheral */
  l3g->i2c_p = i2c_p;
  /* set i2c address */
...
static void l3gd20_i2c_tx_reg(struct L3gd20 *l3g, uint8_t reg, uint8_t val)
{
...
static void l3gd20_send_config(struct L3gd20 *l3g)
{
  switch (l3g->init_status) {
    case L3G_CONF_REG1:
      l3gd20_i2c_tx_reg(l3g, L3GD20_REG_CTRL_REG1, l3g->config.ctrl_reg1);
      l3g->init_status++;
      break;
    case L3G_CONF_REG5:
      l3gd20_i2c_tx_reg(l3g, L3GD20_REG_CTRL_REG5, l3g->config.ctrl_reg5);
      l3g->init_status++;
      break;
    case L3G_CONF_DONE:
...
void l3gd20_event(struct L3gd20 *l3g)
{
  if (l3g->initialized) {
    ...
    if (l3g->i2c_trans.status == I2CTransFailed) {
      l3g->init_status--;
      l3g->i2c_trans.status = I2CTransDone;
      l3gd20_send_config(l3g); // Retry config (TODO max retry)
    }
  }
}
